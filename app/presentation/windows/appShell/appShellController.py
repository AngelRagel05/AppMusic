...
class AppShellController:
    def __init__(
        ...
        self._comparison_controller = ComparisonController(
            page=view.page.comparisonPage,
            view_model=library_comparison_view_model,
        )
    ...
    def initialize(self) -> None:
        ...
        self._view.page.sidebar.comparisonRequested.connect(self._comparison_controller.load)

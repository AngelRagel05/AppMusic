...
from app.presentation.shared.theme import Signal
...
class NavigationMenu(ctk.CTkFrame):
    def __init__(self, parent, theme) -> None:
        ...
        self._buttons = {
            ...
            "youtubePlaylists": self._build_button(
                "Playlist YouTube",
                self.youtubePlaylistsRequested.emit,
            ),
            "ignoredTerms": self._build_button("Filtros", self.ignoredTermsRequested.emit),
        }

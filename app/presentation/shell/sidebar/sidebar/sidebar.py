...
from app.presentation.shell.sidebar.brandPanel.brandPanel import BrandPanel
from app.presentation.shell.sidebar.contextSummary.contextSummary import (
    ContextSummary,
)
from app.presentation.shell.sidebar.navigationFooter.navigationFooter import (
    NavigationFooter,
)
